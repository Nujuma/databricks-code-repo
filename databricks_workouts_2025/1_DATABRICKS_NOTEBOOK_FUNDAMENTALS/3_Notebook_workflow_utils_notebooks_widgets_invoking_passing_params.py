...
print("copying")
dbutils.fs.cp("/Volumes/workspace/default/volumewd36/patients.csv","/Volumes/workspace/default/volumewd36/sample_healthcare_patients1.csv")
...
dbutils.fs.cp("/Volumes/workspace/default/volumewd36/patients.csv","/Volumes/workspace/default/volumewd36/sample_healthcare_patients.csv")
...
print(dbutils.fs.head("/Volumes/workspace/default/volumewd36/sample_healthcare_patients.csv"))
dbutils.fs.put("dbfs:///Volumes/workspace/default/volumewd36/sample_healthcare_patients.csv","put something",True)
