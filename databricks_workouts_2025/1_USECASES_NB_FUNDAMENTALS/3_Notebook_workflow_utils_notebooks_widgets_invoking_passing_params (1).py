...
# MAGIC %sql
# MAGIC CREATE table if not exists default.cities1 (id INTEGER,city VARCHAR(20)); 
# MAGIC insert into cities1 values (15,'Kerala'),(16,'Tamilnadu');
# MAGIC select * from cities1
# MAGIC
...
child_return_value=dbutils.notebook.run("/Workspace/Users/nujumasyed@gmail.com/databricks-code-repo/databricks_workouts_2025/1_DATABRICKS_NOTEBOOK_FUNDAMENTALS/4_child_notebook", 180,{"table_name":"mobile_os_usage"})
print(child_return_value)
                        

# COMMAND ----------

/Volumes/workspace/default/volumewd36if True:
    dbutils.notebook.run("/Workspace/Users/nujumasyed@gmail.com/databricks-code-repo/databricks_workouts_2025/1_DATABRICKS_NOTEBOOK_FUNDAMENTALS/4_child_notebook",600,{"table_name":"mobile_os_usage"})
else:
    dbutils.notebook.run("/Workspace/Users/nujumasyed@gmail.com/databricks-code-repo/databricks_workouts_2025/1_DATABRICKS_NOTEBOOK_FUNDAMENTALS/4_child_notebook",300,{"table_name":"mobile_os_usage"})

# COMMAND ----------

import time
for i in range(13):
    dbutils.notebook.run("/Workspace/Users/nujumasyed@gmail.com/databricks-code-repo/databricks_workouts_2025/1_DATABRICKS_NOTEBOOK_FUNDAMENTALS/4_child_notebook",300)
    time.sleep(10)
...
# MAGIC %sql
# MAGIC Create table if not exists custs
# MAGIC (custid integer,fname varchar(10),lname varchar(10),age integer,profession
# MAGIC varchar(10));
# MAGIC
...
# MAGIC %sql
# MAGIC insert into custs values (1,'John','Doe',30,'Engineer');
# MAGIC insert into custs values (2,'Jane','Doe'  ,25,'Doctor');
# MAGIC insert into custs values (3,'Alice','Smith' ,35,'Teacher');
# MAGIC
# MAGIC select * from custs
